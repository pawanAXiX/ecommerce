<template>
    <div class=" w-full fixed top-0 flex flex-row items-center justify-around gap-10 py-4 bg-white border-b border-gray-200">
...
onBeforeMount(async () => {
    const response = await apiCall.fetchProducts();
